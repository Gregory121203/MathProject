...
"L'arbre de décision", celui-ci sert à classifier une série de donné futur grâce à des données déjà connue. Petite exemple par rapport à l'acceptation d'un crédit bancaire; 2201 clients au départ dont 1427 cibles (dont le crédit a été accepté), 774 non cible(crédit refusé). La variable séparant le mieux les dossiers est l'âge du client. Ensuite, en observant mieux, il est possible de remarquer que chez les 18 à 42 ans, le taux d'accepation est plus élevé mais est surtout accepté au personne ayant des revenus supérieur à 55k euros. Pour les 43 à 62 ans, le sexe est la variable la plus explicative, les femmes ont un taux d'acceptation plus élevé que les hommes. Enfin, pour les plus de 63 ans, le taux d'accepation de crédit est très faible et ne dépend plus d'autre variable car l'âge pour eux est déjà la variable la plus explicative.\\

\begin{figure}[h]
\includegraphics[scale=1]{../exemple d'algorithme pour le machine learning.png} 
\end{figure}
